    ...
    <div class="nav-container">
        ...
        <div class="nav-search-container" id="navSearchContainer">
            <div class="nav-search-wrapper">
                <input type="text" class="nav-search-input" id="navSearchInput" placeholder="Search slots, reviews, guides...">
                ...
                <div class="search-section">
                    ...
                    <div class="popular-searches">
                        ...
                        <a href="index.html#editors-choice-review" class="search-option">
                            <span class="icon">👑</span>
                            <span>Editor's Choice – Sugar Rush</span>
                        </a>
                        <a href="https://rocketpot.io/" target="_blank" rel="noopener" class="search-option">
                            <span class="icon">🚀</span>
